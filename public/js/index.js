...
createApp({
	...
	showInfo() {
		alert(`
			...
			На этой странице находится интерфейс для ввода произвольных параметров задачи мультипликативного N-мерного рюкзака. Также можно включить ограниченность предметов.
		`.replaceAll("\t", "").trim()) 
	},
